...
const items = [
  ...
  },
  {
    ...
    how: [
      ...
      '',
      // 2026-09-19 修：这里原先写"只有 readonly 和 send 两项"，而代码实际申请了三项。
      // 外部审查指出了这个不一致 —— 而**授权说明写少一项是安全问题**：
      // 用户是照着这段文字做决定的，而那段文字不是真的。
      '**授权范围有三项**（不是两项 —— 这段说明原先写错了，2026-09-19 改正）：',
      '  · gmail.readonly —— 读信',
      '  · gmail.send     —— 发信',
      '  · gmail.modify   —— 改标签、移进回收站（**不含永久删除**）',
      '',
      '`modify` 是 2026-09-17 用户明确要求"授权管理我的邮件"之后加的。',
      '前两项是它的子集，留着是为了让人一眼看出依赖哪两项核心能力。',
      '三项都可以随时在 Google 账号的「第三方访问」里撤销。',
    ],
  },
  {
    name: '模型密钥',
